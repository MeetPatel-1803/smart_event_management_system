...
export class AutoMigration1790245968262 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."user_events_status_enum" AS ENUM('FAILED', 'CANCELLED', 'WAITLISTED', 'REGISTERED', 'PAYMENT_PENDING')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."user_events_status_enum_old" AS ENUM('EXPIRED', 'CANCELLED', 'WAITLISTED', 'REGISTERED', 'PAYMENT_PENDING')`);
